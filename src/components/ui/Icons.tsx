...
export function FigmaIcon({ className = 'w-4 h-4' }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M15.333 11.5c1.472 0 2.667-1.194 2.667-2.667S16.805 6.167 15.333 6.167H12v5.333h3.333zM8.667 6.167h3.333v5.333H8.667a2.667 2.667 0 0 1 0-5.333zM8.667 11.5h3.333v5.333H8.667a2.667 2.667 0 0 1 0-5.333zM12 16.833v2.667a2.667 2.667 0 1 1-2.667-2.667H12zM15.333 11.5H12v5.333h3.333a2.667 2.667 0 1 0 0-5.333z" />
    </svg>
  );
}
